    ...
    <div className="min-h-screen p-8">
      <div className="mx-auto flex max-w-5xl flex-col gap-6">
        <div className="flex items-center justify-between gap-4">
          <Link
            to="/"
            className="inline-flex items-center gap-2 rounded-lg bg-surface px-3.5 py-2 text-sm font-semibold ring-1 ring-border transition hover:bg-surface-2"
          >
        ...
        <header className="flex items-center gap-4 rounded-xl bg-surface p-6 ring-1 ring-border">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm text-muted-foreground">Monitor connected users' mental wellness</p>
          </div>
        </header>
                  ...
                  >
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-3">
                        <div className="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-primary/20 text-xs font-bold text-primary">
                    ...
                    <td className="px-5 py-4">
                      <span className="inline-flex items-center gap-1.5 rounded-lg bg-background px-2.5 py-1 text-xs font-medium ring-1 ring-border">
